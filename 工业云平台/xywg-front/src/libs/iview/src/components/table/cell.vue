    ...
    <div :class="classes" ref="cell">
        ...
        <template v-if="renderType === 'normal'">
            <template v-if="column.tooltip">
                <Tooltip transfer :content="row[column.key]" :disabled="!showTooltip" class="ivu-table-cell-tooltip">
...
<script>
    ...
    import TableSlot from './slot'; // 表格solt
    ...
    export default {
        ...
        created () {
            ...
            } else if (this.column.template) { // 表格solt
