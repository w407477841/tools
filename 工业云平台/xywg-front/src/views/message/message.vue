...
export default {
    ...
    methods: {
        ...
        getContent (index) {
            ...
            switch (this.currentMessageType + index) {
                case 'unread0': mesContent = '这是您点击的《欢迎登录星云网格后台管理系统，来了解他的用途吧》的相关内容。'; break;
                case 'unread1': mesContent = '这是您点击的《使用iView-admin和iView-ui组件库快速搭建你的后台系统吧》的相关内容。'; break;
                case 'unread2': mesContent = '这是您点击的《喜欢星云网格的话，欢迎到github主页给个star吧》的相关内容。'; break;
    ...
    mounted () {
        this.currentMesList = this.unreadMesList = [
            ...
            {
                title: '喜欢星云网格的话，欢迎到github主页给个star吧',
                time: 1507390106000
            }
        ];
        this.hasreadMesList = [
